    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-blue-50 to-indigo-100 overflow-hidden relative">
      ...
      <div className="absolute bottom-0 left-10 text-blue-200">
        <svg viewBox="0 0 100 100" className="w-32 h-32">
          <path
            d="M10,90 Q30,60 10,30 Q50,40 50,20 Q50,40 90,30 Q70,60 90,90"
            fill="currentColor"
          />
        </svg>
      </div>
      <div className="absolute bottom-0 right-10 text-blue-200">
        <svg viewBox="0 0 100 100" className="w-24 h-24">
          <path
            d="M10,90 Q30,40 10,10 Q50,30 50,10 Q50,30 90,10 Q70,40 90,90"
            fill="currentColor"
          />
        </svg>
      </div>
      ...
      <div className="w-full max-w-5xl mx-8 z-10 relative">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
          <button
            ...
            className="px-6 py-3 bg-blue-600 text-white rounded-lg cursor-pointer hover:bg-blue-700 transition-colors shadow-md"
          >
            Return to Dashboard
          </button>
        </div>
